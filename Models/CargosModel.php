<?php 
	...
	class CargosModel extends Mysql
	{
		...
		{
			$sql = "SELECT top 1 MAX(idcargo) as id FROM cargo  group by idcargo ORDER BY idcargo DESC";
		...
		public function insertCargo(int $id, string $nombre){ //Inserta la categoria nueva a la base de datos
			$return = "";
			...
			{
				$query_insert  = "INSERT INTO cargo(idcargo, nombre) VALUES(?, ?)";
	        	$arrData = array($id, $nombre);
