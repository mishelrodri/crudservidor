...
CREATE TABLE `compra` (
  ...
  KEY `fk_compraprov` (`idproveedor`) USING BTREE,
  KEY `fk_usucompra` (`idusuario`) USING BTREE,
  CONSTRAINT `fk_compraprov` FOREIGN KEY (`idproveedor`) REFERENCES `proveedor` (`idproveedor`),
  CONSTRAINT `fk_usucompra` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idusuario`)
...
CREATE TABLE `detallecompra` (
  ...
  KEY `fk_compra` (`idcompra`) USING BTREE,
  KEY `fk_productocompra` (`idproducto`) USING BTREE,
  CONSTRAINT `fk_compra` FOREIGN KEY (`idcompra`) REFERENCES `compra` (`idcompra`),
  CONSTRAINT `fk_compraprod` FOREIGN KEY (`idproducto`) REFERENCES `producto` (`idproducto`)
...
CREATE TABLE `detalleventa` (
  ...
  `cantidad` int(11) NOT NULL,
  PRIMARY KEY (`iddetalle`) USING BTREE,
  KEY `fk_productoventa` (`idventa`) USING BTREE,
  KEY `fk_ventaprod` (`idproducto`) USING BTREE,
  CONSTRAINT `fk_venta` FOREIGN KEY (`idventa`) REFERENCES `venta` (`idventa`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ventaprod` FOREIGN KEY (`idproducto`) REFERENCES `producto` (`idproducto`)
...
INSERT INTO detalleventa VALUES("36","25","20","3");
...
CREATE TABLE `empleado` (
  ...
  KEY `fk_cargo` (`idcargo`) USING BTREE,
...
CREATE TABLE `imagen` (
  ...
  KEY `fk_imagenprod` (`productoid`) USING BTREE,
  CONSTRAINT `fk_imagenprod` FOREIGN KEY (`productoid`) REFERENCES `producto` (`idproducto`)
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `permisos` (
  ...
  KEY `moduloid` (`moduloid`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `producto` (
  ...
  KEY `fk_marcaprod` (`idmarca`) USING BTREE,
  KEY `fk_unidadmprod` (`idunidadmedida`) USING BTREE,
  KEY `fk_categoria` (`idcategoria`) USING BTREE,
  CONSTRAINT `fk_categoria` FOREIGN KEY (`idcategoria`) REFERENCES `categoria` (`idcategoria`),
  CONSTRAINT `fk_marcaprod` FOREIGN KEY (`idmarca`) REFERENCES `marca` (`idmarca`),
  CONSTRAINT `fk_unidadmprod` FOREIGN KEY (`idunidadmedida`) REFERENCES `unidadmedida` (`idunidad`)
...
INSERT INTO producto VALUES("20","00013","STANLEY - CUBO 9MM MANDO 1/4 PULG 6 PUNTOS","1","97","","41","15","16","1.584");
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `usuario` (
  ...
  KEY `rolid` (`rolid`) USING BTREE,
  KEY `fk_empleado` (`idempleado`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci ROW_FORMAT=DYNAMIC;

INSERT INTO usuario VALUES("1","ferreteriagradanenio12@gmail.com","a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3","1","0b65b43021e8a7d0b279-023afce364079eeb5b25-9697396b0fe0fa9f0225-4ad6f34c0e4fbacd7e7a","1","2021-08-11 16:22:35","2");
...
CREATE TABLE `venta` (
  ...
  KEY `fk_clienteventa` (`idcliente`) USING BTREE,
  KEY `fk_usuventa` (`idusuario`) USING BTREE,
  CONSTRAINT `fk_clienteventa` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`idcliente`),
  CONSTRAINT `fk_usuventa` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idusuario`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
INSERT INTO venta VALUES("25","19","1","2022","5.36","1","27","17","4.74","0.62");
